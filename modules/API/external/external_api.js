...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Finueva Meet in it.
     *
    ...
    /**
     * Getter for the large video element in Finueva Meet.
     *
    ...
    /**
     * Getter for the prejoin video element in Finueva Meet.
     *
    ...
    /**
     * Getter for participant specific video element in Finueva Meet.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Finueva Meet
    ...
    /**
     * Removes the listeners and removes the Finueva Meet frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Finueva Meet.
     *
     ...
     * Only applies to certain Finueva Meet deploys.

...
function initCommands() {
    commands = {
         ...
         * Only applies to certain C-Meet deploys.
 ...
 * interface to access C-Meet features by external applications that embed
 * C-Meet.
 */
class API {
    _enabled;
     ...
     * information from external applications that embed C-Meet. It also

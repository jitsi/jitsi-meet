...
export class Participant {
    ...
    /**
     * Whether the current frame is the main frame. This could coincide with the Finueva Meet frame (when it's loaded
    ...
    /**
     * Switches to the main frame context (outside the iFrame; where the Finueva Meet iFrame API is available).
     *
    ...
    /**
     * Switches to the iFrame context (inside the iFrame; where the Finueva Meet application runs).
     *
     * If this Participant was initialized with iFrameApi=false this is a no-op.
     */

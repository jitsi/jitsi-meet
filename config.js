...
var config = {
    ...
    // Moves all C-Meet 'beforeunload' logic (cleanup, leaving, disconnecting, etc) to the 'unload' event.
    ...
    */
     ...
     * which is retrieved internally by C-Meet) (e.g. https://meet.jit.si/someMeeting

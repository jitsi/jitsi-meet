    ...
    return {
        root: {
            ...
            '& .mock-atlaskit-label': {
                ...
                fontWeight: 600,
                lineHeight: 1.33,
                padding: `${theme.spacing(4)}px 0px ${theme.spacing(1)}px 0px`
            },
...
function _mapStateToProps(state, ownProps) {
    ...
    if (showDeviceSettings) {
        tabs.push({
            ...
            styles: `settings-pane ${classes.root} devices-pane`,
    ...
    if (showProfileSettings) {
        tabs.push({
            ...
            styles: `settings-pane ${classes.root} profile-pane`,
    ...
    if (showModeratorSettings) {
        tabs.push({
            ...
            styles: `settings-pane ${classes.root} moderator-pane`,
    ...
    if (showCalendarSettings) {
        tabs.push({
            ...
            styles: `settings-pane ${classes.root} calendar-pan`
        });
    }
    ...
    if (showMoreTab) {
        tabs.push({
            ...
            styles: `settings-pane ${classes.root} more-pane`,

...
class WelcomePage extends AbstractWelcomePage {
    ...
    _renderFooter() {
        const { t } = this.props;
        const { MOBILE_DOWNLOAD_LINK_ANDROID, MOBILE_DOWNLOAD_LINK_F_DROID } =
            interfaceConfig;
                ...
                <div className="welcome-footer-centered">
                    <div className="welcome-footer-padded">
                        <div className="welcome-footer-row-block welcome-footer--row-1">
                            ...
                            <a
                                className="Sida da CCS"
                                href="https://cefis.cloud/"
                            >
                                <img
                                    alt={t(
                            ...
                            <a
                                className="Site da Cefis Pay"
                                href="https://cefispay.com.br/"
                            >
                                <img
                                    alt={t(

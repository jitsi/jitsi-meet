...
import { IntroPageButton } from '../IntroPageButton';
import tutorialStyles from './styles';
import { ColorPalette, calcPixelByWidthRatio, calcPixelByHeightRatio } from '../../../base/styles';
...
const video = require('../../BigBuckBunny.mp4');
...
const StepOne = (props: Props) => (<View
    ...
    <View
        ...
        <View style = { tutorialStyles.stepOne.innerUpperContainer }>
            ...
            <IntroPageButton
                borderColor = { ColorPalette.jane }
                content = 'Next'
                onPress = { () => {
                    props.dispatch(setScreen('stepTwo'));
                } }
                textColor = { ColorPalette.jane } />
        </View>
    ...
    <View
        ...
        <View style = { tutorialStyles.stepTwo.innerUpperContainer }>
            ...
            <Video
                ...
                source = { video }
                style = {{
                    width: calcPixelByWidthRatio(isIpad ? 511 : 291),
                    height: calcPixelByHeightRatio(isIpad ? 288 : 210)
                }} />
        </View>
...
const StepThree = (props: Props) => (<View
    ...
    <View
        ...
        <View style = { tutorialStyles.stepThree.innerUpperContainer }>
            <FontAwesomeIcon
                color = { ColorPalette.jane }
                icon = { faEnvelope }
                size = { calcPixelByWidthRatio(isIpad ? 161 : 130) } />
    ...
    <View
        ...
        <View style = { tutorialStyles.stepFour.innerLowerContainer }>
            <IntroPageButton
                borderColor = { ColorPalette.jane }
                content = 'Next'
                marginBottom = { calcPixelByHeightRatio(36) }
                onPress = { () => {

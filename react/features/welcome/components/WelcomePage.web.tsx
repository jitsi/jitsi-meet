            ...
            <div className={`welcome ${contentClassName} ${footerClassName}`} id="welcome_page">
                <div className="header">
                    ...
                    <div className="header-container">
                        ...
                        <h1 className="header-text-title" style={{ color: "black", fontWeight: "bold" }}>
                            {t("welcomepage.headerTitle")}
                        </h1>
                        <span className="header-text-subtitle" style={{ color: "black" }}>
                    ...
                    <div className="welcome-footer-padded">
                        ...
                        >
                            <div
                                ...
                                style={{ fontSize: "14px", color: "#fff", textAlign: "center" }}
                            >
                                &copy; {currentYear} Multiaccess
                            </div>
                        </div>
                    </div>
                </div>

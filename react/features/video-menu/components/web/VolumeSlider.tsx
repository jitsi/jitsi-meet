...
const VolumeSlider = ({ initialValue, onChange }: IProps) => {
    ...
    const updateSliderBackground = (value: number) => {
        if (sliderRef.current) {
            ...
            sliderRef.current.style.background = `linear-gradient(to right, ${theme.palette.primary.main} ${percentage}%, ${theme.palette.grey[300]} ${percentage}%)`;
        }
    };

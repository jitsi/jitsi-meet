 ...
 */
class KickEveryoneButton extends AbstractButton<Props, *> {
    accessibilityLabel = 'toolbar.accessibilityLabel.kick';
    icon = IconKick;
    label = 'toolbar.kickEveryone';
    tooltip = 'toolbar.kickEveryone';
...
export default translate(connect(_mapStateToProps)(KickEveryoneButton));

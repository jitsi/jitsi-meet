 ...
 */
export default function Toolbox({ toolbarButtons, renderType }: IProps) {
    const toolBarBackground = `${renderType === "premeeting" ? "transparent" : "rgba(255, 255, 255, 0.9) !important"}`;
    ...
    return (
        <div className={cx(rootClassNames, shiftUp && "shift-up")} id="new-toolbox">
            <div className={containerClassName}>
                ...
                >
                    <div className={cx("toolbox-content-items", classes.toolboxButton)} ref={_toolboxRef}>
                        {mainMenuButtons.map(
                            ({ Content, key, ...rest }) =>

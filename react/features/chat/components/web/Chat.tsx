...
const Chat = ({
    ...
    const onDragHandlePointerDown = useCallback((e: React.PointerEvent) => {
        ...
        console.log('Chat resize: Pointer down', { clientX: e.clientX, initialWidth: _width, pointerType: e.pointerType });
    }, [ _width, dispatch ]);
    ...
    const onDragPointerUp = useCallback(() => {
        if (isMouseDown) {
            ...
            console.log('Chat resize: Pointer up');
        }
    ...
    const onChatResize = useCallback(throttle((e: PointerEvent) => {
        // console.log('Chat resize: Pointer move', { clientX: e.clientX, isMouseDown, mousePosition, _width });

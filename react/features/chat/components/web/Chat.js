...
// _onChatInputResize: (chatRef) => void;

// /**
//  * Callback invoked when {@code ChatInput} changes height. Preserves
//  * displaying the latest message if it is scrolled to.
//  *
//  * @param {chatRef} chatRef - Chat ref.
//  * @private
//  * @returns {void}
//  */
// _onChatInputResize(chatRef) {
//     if (chatRef?.current?.clientHeight) {
//         // one step behind

//         // console.log('my set', chatRef?.current.clientHeight);
//         // this.setState({
//         //     chatInputHeight: chatRef?.current?.clientHeight
//         // });
//     }

    ...
    override render() {
        ...
        return (
            <div className={className} id="largeVideoContainer" ref={this._containerRef} style={style}>
                ...
                <Watermarks
                    defaultJitsiLogoURL={interfaceConfig.DEFAULT_WELCOME_PAGE_LOGO_URL || "images/logoContent1.png"}
                    noMargins={false}
...
function _mapStateToProps(state: IReduxState) {
    ...
    return {
        ...
        _displayScreenSharingPlaceholder: Boolean(
            isLocalScreenshareOnLargeVideo && !seeWhatIsBeingShared && !isSpotTV(state)
        ),

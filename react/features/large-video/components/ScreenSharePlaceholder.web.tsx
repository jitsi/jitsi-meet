...
const ScreenSharePlaceholder: React.FC<{ t: Function }> = ({ t }) => {
    ...
    const updateShowMeWhatImSharing = () => {
    ...
    return (
        <div className = {classes.overlayContainer}>
            <div className = {classes.content}>
                <div className = {classes.laptop}></div>
                <div className = {classes.laptopStand}></div>
                <span className = {classes.sharingMessage}>{ t('largeVideo.screenIsShared') }</span>
                <span role="button" className = {classes.showSharing} onClick={updateShowMeWhatImSharing}>{ t('largeVideo.showMeWhatImSharing') }</span>
            </div>
        </div>
    );
};

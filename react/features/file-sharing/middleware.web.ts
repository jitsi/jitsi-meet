...
import { DOWNLOAD_FILE, FILE_LIST_RECEIVED, REMOVE_FILE, UPLOAD_FILES } from './actionTypes';
import { addFile, fileRemoved, removeFile, updateFileProgress } from './actions';
...
StateListenerRegistry.register(
    ...
    (conference, { dispatch }, previousConference) => {
        if (conference && !previousConference) {
            ...
            conference.on(JitsiConferenceEvents.FILE_SHARING_FILES_RECEIVED, (files: Array<IFileMetadata>) => {
                dispatch({

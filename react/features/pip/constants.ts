...
/**
 * Relay check delay in PiP video element.
 */
export const FOCUS_CHECK_DELAY_MS = 100;

/**
 * Webkit PiP playback recovery timeout in PiP Video element.
 */
export const WEBKIT_PIP_PLAYBACK_RECOVERY_TIMEOUT_MS = 300;
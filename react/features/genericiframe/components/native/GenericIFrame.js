 ...
 */
class GenericIFrame extends PureComponent<Props> {
    /**
    ...
    render() {
        ...
        return (
            <JitsiModal
                headerProps = {{
                    headerLabelKey: 'genericIFrameSharing.title',
                }}
                modalId = { SHARE_GENERICIFRAME_VIEW_ID }
...
export function _mapStateToProps(state: Object) {
    const { editing } = state['features/genericiframe'];
    const documentUrl = getGenericIFrameUrl(state);
...
export default translate(connect(_mapStateToProps)(GenericIFrame));

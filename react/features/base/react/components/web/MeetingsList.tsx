...
//   // Format to show "Mar 12" as in the image
//   return getLocalizedDateFormatter(date).format("MMM D");
// }
...
//     // Format to show time as "5:32 PM" as in the image
//     return times[0] ? getLocalizedDateFormatter(times[0]).format("h:mm A") : "";
//   }
...
// /**
//  * Formats duration as "00:10", "00:45", etc. As shown in the image.
//  *
//  * @param {number} duration - Duration in minutes.
//  * @private
//  * @returns {string}
//  */
// function _formatDuration(duration: number) {
...
//           <Text className="meeting-title">{title}</Text>
//         </Container>
//         <Container className="right-column">
//           <Text className="duration-display">
//             {typeof duration === "number" ? _formatDuration(duration) : ""}
//           </Text>
//         </Container>

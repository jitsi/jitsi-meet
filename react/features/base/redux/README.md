Finueva Meet - redux state persistence
====================================
Finueva Meet has a persistence layer that persists specific subtrees of the redux
...
When it's done, Finueva Meet will automatically persist these subtrees and

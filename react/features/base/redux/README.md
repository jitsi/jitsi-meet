Medistack Meet - redux state persistence
====================================
Medistack Meet has a persistence layer that persists specific subtrees of the redux
...
When it's done, Medistack Meet will automatically persist these subtrees and

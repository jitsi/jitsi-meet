...
/**
 * Restores a Medistack Meet config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The Medistack Meet config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "Medistack Meet"
    // }
    // We want to have:
    // json = {
    //     config: {

...
/**
 * Restores a Finueva Meet config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The Finueva Meet config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "Finueva Meet"
    // }
    // We want to have:
    // json = {
    //     config: {

 ...
 * JitsiMeetJS#init(). The app will download config.js from the C-Meet
 ...
 * The app will download config.js from the C-Meet deployment and take its
 ...
 * config.js from the C-Meet deployment and take its values into account but
...
function _setConfig(state: IConfig, { config }: { config: IConfig; }) {
    ...
    const newState = _.merge(
        ...
        // downloaded from the C-Meet deployment because the former contains

...
export type DeeplinkingMobileConfig = {
    appName: string;
    appPackage?: string;
    appScheme: string;
    downloadLink: string;
    dynamicLink?: MobileDynamicLink;
};

export type DeeplinkingConfig = {
    android?: DeeplinkingMobileConfig;
    desktopAppName: string;
    disabled: boolean;
    hideLogo: boolean;
    ios?: DeeplinkingMobileConfig;
    showImage: boolean;
};

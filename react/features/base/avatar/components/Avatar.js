...
export type Props = {
    ...
    /**
     * A string to override the avatar background color generated by initials logic.
     */
    ...
    /**
     * Whether or not to use initials in the middle of the avatar.
     */
    ignoreInitials?: boolean,
...
class Avatar<P: Props> extends PureComponent<P, State> {
    ...
    render() {
        ...
        const initials = ignoreInitials ? null : getInitials(_initialsBase);
        ...
        if (avatarBackgroundColor) {
            avatarProps.color = avatarBackgroundColor;
        }

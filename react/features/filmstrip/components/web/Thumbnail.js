...
export type Props = {|
    ...
    /**
     * Whether we are running in a mobile browser.
     */
    _isMobile: boolean,
    ...
    /**
     * Whether the current layout is tile view.
     */
    _isTileView: boolean,
...
function _mapStateToProps(state, ownProps): Object {
    ...
    return {
        ...
        _isTileView: _currentLayout === LAYOUTS.TILE_VIEW,

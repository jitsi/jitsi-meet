...
class LobbyScreen extends AbstractLobbyScreen {
    ...
    render() {
        ...
        return (
            <JitsiScreen
                style = { this.props._challengeResponseIsActive
                    ? styles.challengeResponseWrapper
                    : styles.contentWrapper }>
                {this.props._challengeResponseIsActive
                    ? this._renderChallengeResponse()
                    : <SafeAreaView>
    ...
    /**
     * Renders the challenge response chat.
     *
     * @inheritdoc
     */
    _renderChallengeResponse() {
        const { t } = this.props;

        return (
            <>
                <Text style = { styles.dialogTitle }>
                    { t(this._getScreenTitleKey(), { moderator: this.props._challengeResponseRecipient }) }
                </Text>
                <MessageContainer messages = { this.props._challengeResponses } />

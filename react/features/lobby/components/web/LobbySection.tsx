...
class LobbySection extends PureComponent<IProps, IState> {
    ...
    static getDerivedStateFromProps(props: IProps, state: IState) {
        return props._lobbyEnabled !== state.lobbyEnabled
            ? { lobbyEnabled: props._lobbyEnabled }
            : null;
    }
    ...
    render() {
        ...
        return (
            <div id="lobby-section">
                <p className="description" role="banner">
 ...
 /**
    ...
    _onToggleLobby() {
        ...
        this.setState({ lobbyEnabled: newValue });
...
function mapStateToProps(state: IReduxState) {
    ...
    return {
        ...
        _visible: conference?.isLobbySupported() &&

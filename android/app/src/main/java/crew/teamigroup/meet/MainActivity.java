...
import crew.teamigroup.meet.sdk.JitsiMeet;
import crew.teamigroup.meet.sdk.JitsiMeetActivity;
import crew.teamigroup.meet.sdk.JitsiMeetConferenceOptions;
...
public class MainActivity extends JitsiMeetActivity {
    ...
    protected boolean extraInitialize() {
        ...
        try {
            Class<?> cls = Class.forName("crew.teamigroup.meet.GoogleServicesHelper");

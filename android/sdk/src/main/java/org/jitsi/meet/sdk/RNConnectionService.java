...
/**
 * The react-native side of Medistack Meet's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by Medistack Meet to
     *        a conference call.
     * @param handle - a call handle which by default is Medistack Meet room's URL.

...
public class BroadcastEvent {
    ...
    public enum Type {
        ...
        ENDPOINT_MESSAGE_RECEIVED("org.jitsi.meet.ENDPOINT_MESSAGE_RECEIVED");
        ...
        private static final String ENDPOINT_MESSAGE_RECEIVED_NAME = "ENDPOINT_MESSAGE_RECEIVED";
        ...
        private static Type buildTypeFromName(String name) {
            switch (name) {
                ...
                case ENDPOINT_MESSAGE_RECEIVED_NAME:
                    return ENDPOINT_MESSAGE_RECEIVED;
            }

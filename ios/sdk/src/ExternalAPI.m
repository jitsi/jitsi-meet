...
static NSString * const sendMessageAction = @"org.jitsi.meet.SEND_MESSAGE";
...
- (NSArray<NSString *> *)supportedEvents {
    return @[ hangUpAction, setAudioMutedAction, sendMessageAction ];
}
...
- (void)sendMessage:(NSString*)to :(NSString*)message {
    ...
    [self sendEventWithName:sendMessageAction body:data];
}

...
Using Jitsi Meet is straightforward, as it's browser based. Head over to [go.crewsa.net](https://go.crewsa.net) and give it a try. It's anonymous, scalable and free to use. All browsers are supported! 
